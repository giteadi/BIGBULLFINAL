      ...
      <aside className="lg:w-1/4 w-full">
        <div className="card">
          <div className="card-body">
            ...
            <dl className="dlist-align">
              <dt>Discount:</dt>
              <dd className="text-end text-green-500">{`₹ ${cartCourses.reduce((sum, course) => sum + Number(course.price), 0) * 0.82}`}</dd>
            </dl>
            <dl className="dlist-align">
              <dt>TAX:</dt>
            ...
            <div className="my-3 space-y-2">
              <button className="bg-red-600 py-2 rounded-lg text-white text-lg w-full">Buy Now</button>
